...
main(int argc, char *argv[])
{
  ...
  16:	8ae50513          	addi	a0,a0,-1874 # 8c0 <malloc+0xf4>
  1a:	6fa000ef          	jal	714 <printf>
    exit(1);
  1e:	4505                	li	a0,1
  ...
  3c:	8a858593          	addi	a1,a1,-1880 # 8e0 <malloc+0x114>
  40:	6525                	lui	a0,0x9
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	52080813          	addi	a6,a6,1312 # 910 <digits>
 3f8:	88be                	mv	a7,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c0:	24c48493          	addi	s1,s1,588 # 908 <malloc+0x13c>
        for(; *s; s++)
