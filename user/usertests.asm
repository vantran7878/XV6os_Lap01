...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    515a:	00004797          	auipc	a5,0x4
    515e:	2f67b783          	ld	a5,758(a5) # 9450 <freep>
    ...
    5186:	00e6ea63          	bltu	a3,a4,519a <free+0x4c>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    51c4:	00004717          	auipc	a4,0x4
    51c8:	28f73623          	sd	a5,652(a4) # 9450 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    51f6:	25e53503          	ld	a0,606(a0) # 9450 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    521e:	00004497          	auipc	s1,0x4
    5222:	23248493          	addi	s1,s1,562 # 9450 <freep>
  if(p == (char*)-1)
    5226:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    5232:	0000b797          	auipc	a5,0xb
    5236:	a4678793          	addi	a5,a5,-1466 # fc78 <base>
    523a:	00004717          	auipc	a4,0x4
    523e:	20f73b23          	sd	a5,534(a4) # 9450 <freep>
  ...
  if(p == (char*)-1)
    ...
    52a0:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    52a4:	00004717          	auipc	a4,0x4
    52a8:	1aa73623          	sd	a0,428(a4) # 9450 <freep>
      return (void*)(p + 1);
