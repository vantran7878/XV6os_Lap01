...
main(int argc, char *argv[])
{
  ...
  20:	4725                	li	a4,9
  22:	00f77d63          	bgeu	a4,a5,3c <main+0x3c>
    fprintf(2, "Usage: %s mask command\n", argv[0]);
  26:	6090                	ld	a2,0(s1)
  28:	00001597          	auipc	a1,0x1
  2c:	8b858593          	addi	a1,a1,-1864 # 8e0 <malloc+0xf4>
  30:	4509                	li	a0,2
  32:	6d8000ef          	jal	70a <fprintf>
    exit(1);
  36:	4505                	li	a0,1
  38:	2e2000ef          	jal	31a <exit>
  }

  if (trace(atoi(argv[1])) == -1) {
  3c:	1dc000ef          	jal	218 <atoi>
  40:	382000ef          	jal	3c2 <trace>
  44:	57fd                	li	a5,-1
  46:	02f50063          	beq	a0,a5,66 <main+0x66>
  ...
  4e:	6888                	ld	a0,16(s1)
  50:	302000ef          	jal	352 <exec>
  printf("trace: exec failed\n");
  54:	00001517          	auipc	a0,0x1
  58:	8bc50513          	addi	a0,a0,-1860 # 910 <malloc+0x124>
  5c:	6d8000ef          	jal	734 <printf>
  exit(0);
  60:	4501                	li	a0,0
  62:	2b8000ef          	jal	31a <exit>
    fprintf(2, "%s: trace failed\n", argv[0]);
  66:	6090                	ld	a2,0(s1)
  68:	00001597          	auipc	a1,0x1
  6c:	89058593          	addi	a1,a1,-1904 # 8f8 <malloc+0x10c>
  70:	4509                	li	a0,2
  72:	698000ef          	jal	70a <fprintf>
    exit(1);
  76:	4505                	li	a0,1
